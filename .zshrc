...
setbg () {
	dir=$(pwd)
	WALLPAPER=$( find "$HOME/.dotfiles/wallpapers/pywallpapers" -type f -print0 | shuf -z -n 1 )
	wal -i $WALLPAPER -q
	pywal-discord
	cd "$HOME/.config/dwm"
...
#source "/home/aidan/.cache/yay/dasht/src/dasht-2.4.0/etc/zsh/completions.zsh"
